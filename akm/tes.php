		...
		<div class="row" style="height:55px;">
			<div class="col-md-12">
				...
				<!-- <div>
					...
					echo '<div id="hapus" class="alert alert-success" style="display:none;" ;">'.$_SESSION['hapus'].'</div>';
					}
					$_SESSION['hapus'] = '';
					?>
				</div> -->
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal<?php echo $data['no']; ?>">Edit</a>|<a href="hapus.php?no=<?php echo $data['no']; ?>" onclick="return confirm('Yakin Hapus?')" class="hapus">HAPUS</a>
								</td>
							</tr>
